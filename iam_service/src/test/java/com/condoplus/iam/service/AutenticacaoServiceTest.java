...
class AutenticacaoServiceTest {
    ...
    void deveAutenticarComCredenciaisCorretas() {
        ...
        when(jwtService.gerarToken(cred))
    ...
    void deveBloquearAposCincoTentativas() {
        ...
        assertThat(cred.getStatus())
                .isEqualTo(StatusCredencial.BLOQUEADO_TEMPORARIAMENTE);

        assertThat(cred.getBloqueadoAte())
    ...
    void deveDesbloquearAutomaticamenteAposExpirarJanela() {
        ...
        cred.setBloqueadoAte(LocalDateTime.now().minusMinutes(1));
