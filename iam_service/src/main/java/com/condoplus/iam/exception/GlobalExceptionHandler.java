...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> lidarCredenciaisInvalidas(
        ...
        problem.setType(
                URI.create("https://condoplus.local/errors/credenciais-invalidas")
        );
    ...
    public ResponseEntity<ProblemDetail> lidarCredencialBloqueada(
        ...
        problem.setType(
                URI.create("https://condoplus.local/errors/credencial-bloqueada")
        );
    ...
    public ResponseEntity<ProblemDetail> lidarEmailJaExiste(
            EmailJaExisteException ex) {
        ...
        problem.setType(
                URI.create("https://condoplus.local/errors/email-ja-existe")
        );
    ...
    public ResponseEntity<ProblemDetail> lidarNaoEncontrada(
        ...
        problem.setType(
                URI.create("https://condoplus.local/errors/credencial-nao-encontrada")
        );
    ...
    public ResponseEntity<ProblemDetail> lidarValidacao(
        ...
        problem.setType(
                URI.create("https://condoplus.local/errors/validacao")
        );
    ...
    public ResponseEntity<ProblemDetail> lidarAcessoNegado(AuthorizationDeniedException ex) {
        ProblemDetail problem = ProblemDetail.forStatusAndDetail(
                HttpStatus.FORBIDDEN, "Acesso negado");
        problem.setType(URI.create("https://condoplus.local/errors/acesso-negado"));
        problem.setTitle("Acesso negado");
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(problem);
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<ProblemDetail> lidarErroInesperado(
            Exception ex) {
        ...
        problem.setType(
                URI.create("https://condoplus.local/errors/interno")
        );
